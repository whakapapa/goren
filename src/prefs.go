...
class PyrenamerPrefs:
    ...
    def __init__(self, main):
        ...
        self.gconf_options_shown = self.gconf_path + '/visible'
    ...
    def preferences_save(self):
        ...
        client.set_bool(self.visible, self.main.visible)
    ...
    def preferences_read(self):
        ...
        ops.visible = client.get_bool(self.gconf_options_shown)
        if ops.visible != None: self.main.visible = true
